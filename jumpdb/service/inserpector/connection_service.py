...
from jumpdb.service.inserpector.inspector_service import create_inspector
from jumpdb.serializers.inspector import ColumnsIn, ColumnsOut

from jumpdb.serializers.inspector import InspectorIn, ConstraintOut
from jumpdb.serializers.inspector import FkConstraintOut, IndexConstraintOut
from jumpdb.serializers.inspector import SummaryTableOut
...
def get_columns(map_in: ColumnsIn) -> List[ColumnsOut]:
    ...
    try:
        ...
        inspector = create_inspector(database=map_in.database, name=map_in.name)
...
def get_pk_constraint(map_in: InspectorIn) -> ConstraintOut:
    map_out = None
    try:
        inspector = create_inspector(map_in.database, map_in.name)
